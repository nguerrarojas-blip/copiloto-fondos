...
export const QUESTIONS: Record<string, Question> = {
  ...
  // Ámbitos del modelo Canvas (Sercotec: Capital Abeja Emprende y Fondo Crece
  // comparten esta metodología). Se agregan como ids propios — nunca se
  // reutilizan ids ya usados por Semilla Inicia — para que cada ámbito tenga
  // un significado único sin importar el fondo que lo use.
  canvas_clientes:{ field:'Clientes', question:'¿Quiénes son tus clientes y qué los distingue?',
    hint:'El formulario pide identificarlos con al menos un tipo de variable de segmentación (edad, ubicación, poder adquisitivo, frecuencia de compra), no solo nombrarlos.',
    benchmark:'Los adjudicados describen a sus clientes con dos o más variables concretas (por ejemplo, ubicación + frecuencia de compra), no con una categoría genérica.',
    options:[
      { short:'Caseros de ferias libres de la Región Metropolitana, con puesto fijo y venta diaria.',
        formal:'Los clientes son comerciantes de ferias libres de la Región Metropolitana, con puesto fijo y venta diaria, segmentados por ubicación geográfica y frecuencia de venta.' },
      { short:'Caseros que ya venden por WhatsApp pero sin forma de cobrar online.',
        formal:'El segmento de clientes son comerciantes de feria que ya gestionan ventas informales por aplicaciones de mensajería, caracterizados por contar con clientela recurrente pero sin medio de pago digital.' } ] },
  canvas_oferta:{ field:'Oferta de valor / elemento diferenciador', question:'¿Por qué debería preferirte un cliente antes que a la competencia?',
    hint:'El formulario evalúa que la respuesta especifique diferencias concretas con la competencia, no que repita "somos mejores" o "somos innovadores".',
    benchmark:'Los adjudicados nombran el atributo diferenciador y a qué necesidad exacta del cliente responde, no una lista de adjetivos.',
    options:[
      { short:'No cobramos comisión por venta, a diferencia de los marketplaces que sí cobran.',
        formal:'El elemento diferenciador frente a la competencia es la ausencia de comisión por transacción, en contraste con las plataformas de comercio electrónico generalistas que sí la aplican.' },
      { short:'El casero recibe el pago al toque, no como en el delivery que paga días después.',
        formal:'La oferta de valor se sostiene en la liquidación inmediata del pago al comerciante, frente a los canales de delivery existentes que liquidan con desfase.' } ] },
  canvas_canales:{ field:'Canales de distribución', question:'¿Por dónde llegas a tus clientes, y por qué esos canales?',
    hint:'El formulario pide justificar por qué esos canales son los más adecuados para cada tipo de cliente, no solo listarlos.',
    benchmark:'Los adjudicados justifican el canal elegido con un motivo financiero u operacional concreto, no solo lo mencionan.',
    options:[
      { short:'La app misma, más el puesto físico para quienes prefieren pagar al retirar.',
        formal:'El canal principal es la aplicación móvil, complementado con el puesto físico como canal de retiro y pago en efectivo para el segmento de clientes que aún prefiere esa modalidad.' },
      { short:'WhatsApp para tomar pedidos y la app solo para cobrar.',
        formal:'Se utiliza WhatsApp como canal de toma de pedidos, por ser el canal ya adoptado por el cliente, y la aplicación exclusivamente para el cobro digital, reduciendo la fricción de adopción.' } ] },
  canvas_relacion:{ field:'Relación con los clientes', question:'¿Qué tipo de relación tienes o esperas tener con tus clientes?',
    hint:'Indica si mantener esa relación tiene algún costo asociado (soporte, fidelización, etc.).',
    benchmark:'',
    options:[
      { short:'Atención directa por WhatsApp cuando hay un problema con un pedido, sin costo adicional.',
        formal:'La relación con los clientes es de atención directa y personalizada por WhatsApp ante incidencias de pedido, sin costo adicional para el negocio más allá del tiempo de gestión.' },
      { short:'Un grupo de WhatsApp por feria para avisos y promociones.',
        formal:'Se mantiene una relación de comunidad mediante un grupo de mensajería por feria, usado para avisos y promociones, sin costo monetario asociado más allá de la gestión del canal.' } ] },
  canvas_recursos:{ field:'Recursos clave', question:'¿Qué recursos necesitas para que tu oferta llegue a tus clientes?',
    hint:'El formulario pide nombrar y explicar cada recurso, no solo listarlos.',
    benchmark:'Los adjudicados nombran al menos dos recursos clave concretos (no genéricos como "internet" o "personal").',
    options:[
      { short:'El teléfono con la app instalada y una cuenta bancaria para recibir las transferencias.',
        formal:'Los recursos clave son el dispositivo móvil con la aplicación instalada, necesario para publicar la oferta diaria, y una cuenta bancaria habilitada para recibir las transferencias de los clientes.' },
      { short:'Conexión a internet estable en el puesto y las fotos de los productos.',
        formal:'Se requiere conectividad a internet en el punto de venta para publicar y actualizar la oferta, junto con material fotográfico del producto que sostenga la decisión de compra remota.' } ] },
  canvas_actividades:{ field:'Actividades clave', question:'¿Qué actividades tienes que hacer para que tu oferta llegue a tus clientes?',
    hint:'Actividades concretas del día a día del negocio, no objetivos generales.',
    benchmark:'',
    options:[
      { short:'Publicar la oferta del día antes de abrir el puesto y confirmar los pedidos por la mañana.',
        formal:'Las actividades clave son la publicación diaria de la oferta previa a la apertura del puesto y la confirmación de pedidos en la mañana, para coordinar la disponibilidad de producto.' },
      { short:'Coordinar el retiro de los pedidos con cada casero antes del cierre de la feria.',
        formal:'La actividad clave es la coordinación del retiro de pedidos con cada comerciante antes del cierre de la feria, para asegurar la entrega dentro de la jornada.' } ] },
  canvas_alianzas:{ field:'Alianzas clave', question:'¿Con quién te conviene aliarte para atender mejor a tus clientes?',
    hint:'Proveedores, gremios u otras empresas — indica cómo esa alianza mejora lo que recibe el cliente.',
    benchmark:'',
    options:[
      { short:'La asociación de feriantes, para entrar a nuevas ferias con su respaldo.',
        formal:'La principal alianza clave es la asociación de comerciantes de cada feria, cuyo respaldo facilita la adopción del canal digital por parte de sus asociados.' },
      { short:'Un proveedor de transferencias para que el cobro sea instantáneo.',
        formal:'Se identifica como alianza clave un proveedor de servicios de transferencia, que permite que el cobro se acredite de forma instantánea y reduce la fricción de la transacción.' } ] },
  canvas_sustentabilidad:{ field:'Sustentabilidad', question:'¿Qué acciones de eficiencia energética, energías renovables o economía circular tiene o podría incorporar tu negocio?',
    hint:'No hace falta que sea el eje del negocio: basta con una acción concreta ya incorporada o planificada.',
    benchmark:'',
    options:[
      { short:'Los caseros ya reducen la merma porque venden por encargo, no por stock a la vista.',
        formal:'El modelo de venta por encargo reduce la merma de producto perecible respecto de la exhibición tradicional, al ajustar la oferta a la demanda ya confirmada.' },
      { short:'Planeamos sumar un aviso para que los compradores lleven su propia bolsa al retirar.',
        formal:'Se contempla incorporar un aviso en la confirmación de pedido que incentive al comprador a llevar su propio envase o bolsa al momento del retiro, reduciendo el uso de plástico de un solo uso.' } ] },
}
